...
cocktail3 = Cocktail.new(name: "Lemon mojito", user: user)
...
cocktail6 = Cocktail.new(name: "Mango Sunrise", user: user)
...
cocktail17 = Cocktail.new(name: "Dark Moon", user: user)
...
cocktail16 = Cocktail.new(name: "Pear Collins", user: user)
...
cocktail28 = Cocktail.new(name: "Apple Verjus Spritz", user: user)
